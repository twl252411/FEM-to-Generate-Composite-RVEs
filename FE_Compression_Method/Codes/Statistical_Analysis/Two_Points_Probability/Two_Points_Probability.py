...
import pandas as pd
#
FilId, Filnum, strname = 1, 10, 'Star'
RLength, Roi1, Roi2 = 200.0, int(400*1.0)+1, 401
...
for ifl in range(Filnum):
    ...
    data = np.loadtxt('C:\\Temp\\Statistical_Analysis\\Two_Points_Probability\\' + strname + '_RVE\\VoxelElements' + str(Id) + '.txt', dtype=int, delimiter=',')
    #
    phi = np.mean(data)
...
#
writer = pd.ExcelWriter("C:\\Temp\\Statistical_Analysis\\Two_Points_Probability\\"+strname+"_RVE\\Two_Points_Probability_"+strname+".xlsx")
#
#----------------------------------- 3D Contour -------------------------------
#
...
#--------------------------------- Different Distance -------------------------
#
writer = pd.ExcelWriter("C:\\Temp\\Statistical_Analysis\\Two_Points_Probability\\"+strname+"_RVE\\Two_Points_Probability_"+strname+"1.xlsx")
#
