...
RLength, Shdisp, Ampf, Filnum, IncId = 200.0, 0.1, 1.0, 10, 5
...
for ifil in range(1):
    ...
    Mdb()
    #
    f1 = 'C:\\Temp\\Generated_Points_Angles\\'+IncType+'\\NewCentroids'+str(ifil+1)+'.txt'
    f2 = 'C:\\Temp\\Generated_Points_Angles\\'+IncType+'\\NewOriangles'+str(ifil+1)+'.txt'
    #
    ...
    #
    instanceList = ()
    for inc in range(17,len(TranVec)):
