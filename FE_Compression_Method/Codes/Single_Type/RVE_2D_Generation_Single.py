...
#------------------------------------------------------------------------------------
#
RLength, Shdisp, Ampf = 200.0, 0.0, 1.00
RLength1 = RLength + 2*Shdisp
#
f1, f2 = 'C:\Temp\Generated_Points_Angles\Circle\NewCentroids2.txt', 'C:\Temp\Generated_Points_Angles\Circle\NewOriangles2.txt'
PartName, Pathname, IncId = 'Part-1', 'RVE_1.cae', 1
UserVariables = {}
